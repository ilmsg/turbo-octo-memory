defmodule TurboOctoMemoryWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TurboOctoMemoryWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TurboOctoMemoryWeb.Gettext, "errors", msg, opts)
    end
  end
